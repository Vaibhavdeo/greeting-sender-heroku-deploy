...
public class AppConstants {
	...
	public static final String INSERT_QUERY = "insert into GreetingDetails(gId, SP_DATE, subject ,name) values (?, ? , ? , ?)";
	...
	public static final String UPDATE_QUERY = "update GreetingDetails set SP_DATE = ?, name = ?, subject=? where gId = ? ";
